...
raw_path = os.path.join(os.getcwd(),"results","pred","gen_20221204_115559","mask")

new_path = os.path.join(os.getcwd(),"results","pred","gen_20221204_115559","new_mask")
...
for i in tqdm(range(len(raw_list))):
    ...
    new_data = np.dstack([sep1,sep2,sep3])
